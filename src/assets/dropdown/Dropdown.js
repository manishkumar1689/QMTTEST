...
export class Dropdown {
  ...
  eventHandler() {
    switch (this.type) {
      case 'click':
        ...
        this.dom.menu.addEventListener('click', () => this.menu.hide());
        this.ifClickedOutside(() => this.menu.hide());
        break;
      case 'single':
        this.dom.dropdown.addEventListener('change', e => this.selectSingleOption(e), false);
        this.dom.button.addEventListener('click', (e) => this.menu.toggle(e), false);
        this.dom.menu.addEventListener('click', () => this.menu.hide());
        this.ifClickedOutside(() => this.menu.hide());
        break;
      case 'multi':
  ...
  destroy() {
    // console.log("Destroyinng Dropdown");
     ...
     switch (this.type) {
       case 'click':
         this.dom.button.removeEventListener('click', () => this.menu.toggle(), false);
        // this.ifClickedOutside(() => this.menu.hide());
      //   console.log("click");
         break;
       case 'single':
         this.dom.dropdown.removeEventListener('change', e => this.selectSingleOption(e), false);
         this.dom.button.removeEventListener('click', () => this.menu.toggle(), false);
         //this.ifClickedOutside(() => this.menu.hide());
         
         break;
       case 'multi':
         this.dom.dropdown.removeEventListener('change', () => this.selectMultipleOptions(), false);
         this.dom.button.removeEventListener('click', () => this.menu.toggle(), false);
         //this.ifClickedOutside(() => this.menu.hide());
         //console.log("multi");
         break;
       case 'combo':
         this.dom.button.removeEventListener('click', () => this.menu.toggle(), false);
         this.dom.menu.removeEventListener('click', e => this.setInputValue(e.target), false);
         this.dom.input.removeEventListener('click', () => this.menu.show(), false);
         this.dom.input.removeEventListener('keyup', (e) => {
           this.menu.show();
           this.filterOptions();
           this.arrowKeySelection(e);
         }, false);
         this.dom.input.removeEventListener('mousemove', () => this.menu.unHighlightAll(), false);
         //this.ifClickedOutside(() => this.menu.hide());
         break;
       default:
     }
